...
class TestWorker(unittest.TestCase):
    ...
    def test_4(self):
        ...
        cfg = {'provides': [{'name': 'attrs1',
               ...
               'consumes': {
                            ...
                            'results' : [{'name': 'dependency',
                                         ...
                                         {'name': 'dependency2',
                                          'path': 'items_outer[:@IDX_OUTER].value'
                                         }
                                        ],
                           }
              }
        ...
        input_values = {'some_number': 64.,
                        'items_outer.0.attr.items_inner.0.path': 17.,
                        'items_outer.0.attr.items_inner.1.path': 18.,
                        'items_outer.1.attr.items_inner.0.path': 19.,
                        'items_outer.1.attr.items_inner.1.path': 20.,
                        }
        ...
        for key, val in input_values.items():
            ...
            itests_paths_pending.append(set(pending_input_paths) == 
        ...
        results_values = {'value': 11.,
                          'items_outer.1.value': 71.,
                          'items_outer.0.value': 49.,
                          }
    ...
    def test_8(self):
        ...
        tree_for_idxcontext = {'': dummy_tree,
                               tree.get_idx_context(): tree}
