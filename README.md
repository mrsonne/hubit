...
The full documentation, use cases and an in-depth tutorial can be found [here](https://mrsonne.github.io/hubit/). Below is a brief example of how to use `Hubit` once the model is configured.
